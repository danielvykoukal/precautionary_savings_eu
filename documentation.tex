...
(Figure~\ref{fig:F2_total_vs_saving}). This places the composition analysis firmly
...
\extfig{0.9}{F2_total_vs_saving}{Combining all the asset flows reproduces the
...
(Figures~\ref{fig:K2_energy_vs_cash_buffer}--\ref{fig:K_energy_squeeze_by_income}).
...
\fig{0.86}{K2_energy_vs_cash_buffer}{The euro-area energy price level (left, 2019$=$100)
...
\fig{0.78}{K_energy_squeeze_by_income}{Energy budget share (illustrative) versus
